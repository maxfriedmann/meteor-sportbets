...
i18n = function(label)
{
	...
	if (typeof label !== 'string')
		return '';
	return (maps[language] && maps[language][label]) || (maps[defaultLanguage] && maps[defaultLanguage][label]) || (showMissing && _.template(missingTemplate, {
		language : language,
